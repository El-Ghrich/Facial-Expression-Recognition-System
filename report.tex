...
\author{Bilal Magguilej \\ El-Ghrich Salman}
...
Facial expression recognition is a fundamental problem in computer vision with applications in human-computer interaction, affective computing, mental health monitoring, and user experience analysis. The objective of this project was to build a complete FER system from scratch---from raw image data to a live webcam demo---using only TensorFlow and open-source computer vision libraries. The full source code and documentation are available at: \url{https://github.com/El-Ghrich/Facial-Expression-Recognition-System.git}.
